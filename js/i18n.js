...
(function (global) {
  ...
  const STR = {
    ...
    fly_alt: ["距行星表面高度 h (km，对数滑轨)", "Altitude above planet h (km, logarithmic slider)"],
    ...
    fly_legend: ["蓝线：双曲线轨迹；灰虚线：渐近线；绿色：速度方向夹角 δ。", "Blue: hyperbolic trajectory; grey dashed: asymptotes; green: angle δ between velocity directions."],
    ...
    fly_planet_frame_title: ["飞掠几何", "fly-by geometry"],
